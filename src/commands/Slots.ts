import { Collection, User, ActionRowBuilder, ButtonInteraction, Message, ButtonBuilder, ButtonStyle, type TextBasedChannel } from 'discord.js';
...
export default class SlotsCommand extends Command {
    ...
    private async playSlots(interaction: Command.ChatInputCommandInteraction | ButtonInteraction) {
